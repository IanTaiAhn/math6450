...
Overall Normality Assessment: Assumption appears to be violated
    \end{Verbatim}
    \centering
    \adjustimage{max size={0.8\linewidth}{0.8\paperheight}}{Math6450_Assignment2_files/Math6450_Assignment2_53_1.png}
    { \hspace*{\fill} \\}
...
Highest Cooks: Observation 315
  ...
  Cook's distance: 0.0331
    \end{Verbatim}
    \centering
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment2_files/Math6450_Assignment2_55_1.png}
    { \hspace*{\fill} \\}
