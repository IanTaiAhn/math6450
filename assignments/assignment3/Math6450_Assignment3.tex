...
day, and that each year follows a similar pattern.
...
uses that as the new time series column.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_17_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
aggregation will be a good idea for making the variance more normal.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_19_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    The variance is not as prevalent, but still there, so we will move to
log transformations to ensure the data is staionary.

    \subparagraph{Transformations:}\label{transformations}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_22_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
ADF Statistic: -1.1609283961297714
p-value: 0.6901735830954657
    \end{Verbatim}

    ADF Test - Weekly AQI AVG w/ Log Transformation ADF Statistic:
-1.1609283961297714 p-value: 0.6901735830954657

These results show that the aggregation and transformation wasn't enough
to make my series data stationary, so we will try first differencing
before we look at seasonl patterns.
