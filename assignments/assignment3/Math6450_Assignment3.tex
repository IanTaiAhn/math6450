...
day, and that each year follows a similar pattern. This means there is
...
picture view of how the data has changed over the years. However, it can
...
obvious point where we have a seasonal trend. The month of July
...
the monthly data looked a little too smooth, and weekly data looked to
be the most promising since there are still obvious seasonal patterns
and the data didn't look so smooth over it wouldn't capture other
trends.

So, to capture as many AQI patterns as possible the weekly and monthly
data will be used to compare results.

This means that from the daily AQI data we will aggregate the weekly and
monthly means for analyzing, and AQI forecasting.
...
plotted.
    ...
    We first noticed the seasonality of the data in the Daily AQI graph, and
it was made clear there was seasonality when graphing the aggregated
monthly avg AQI dataset. To get rid of this seasonality seasonal
differencing will be needed to ensure this data set is stationary and
ready for modeling.

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_27_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
stationary time series. Both numbers are low so we can assume we have
stationary time series data.

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_30_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
visuals which means air quality does suffer from seasonality.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_32_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
in this data.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_34_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
meaning were making the data more stationarity.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_38_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
lag, there isn't a direct strong influence on the weekly AQI values.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_40_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
accounted for.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_43_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_43_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_43_2.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_43_3.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_43_4.png}
    \end{center}
    { \hspace*{\fill} \\}
...
correlation. I can say since I started this lag in January, 26 weeks ago
January is in the summer, June or July, so it makes sense the lag would
calculate a negative correlation.
...
meaning winter is colder than summer. So, we can confirm that there are
correlation and seasonality in this data, and we will now be able to
select a model to forecast the AQI.
...
is present in this data due to changing seasons.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_46_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
autocorrelation which we saw a little bit of in the ACF plots, and the
...
Diagnostics:}\label{model-parameters-and-diagnostics}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_52_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_52_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_52_2.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_52_3.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_54_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_56_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_58_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Best results by different criteria:
  ...
  Lowest AIC: Monthly AQI (AIC: -1.26)
    ...
    This was an interesting study for many reasons. Firstly, since the time
series data did have seasonality, it was a good exercise to discover
what order difference, and seasonal differences to apply to the data.
Since the dataset was populated quite well, and there weren't any
missing dates, there was no need for dropping N/A values or imputing so
that was nice to not have to handle that. Focusing on the ACF/PACF,
stationarity, and variance let me think more about the seasonality of
the data, and which p/d/q values to choose for the arima model.

In the end the best performing model was the base monthly AQI model that
was aggregated monthly by average. However, the forecasted results given
by this best performing model still couldn't capture the spike,
similarly to most of the other models. I wonder what could have been
done to the data/modeling that would capture the spike for the last
couple weeks, or months in the dataset.
