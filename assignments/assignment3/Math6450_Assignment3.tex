...
picture view to how the data has changed over the years. However, it
smoothed the line too much and it may not be able to capture short-term
...
consistently jumps up in AQI.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_12_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    TODO \textbar{} REVIEW

Using a weekly average for AQI seems to be the most promising due to the
available data, and the graph isn't so smoothed over like it was when
using monthly average AQI. This seems to be a nice middleground between
daily, and monthly AQI averaging.
...
So, in an attempt to capture as much AQI patterns as possible this
weekly model will capture less noise than a daily one, and more detail
than a monthly one.

The aggregation performed gathers the weekly AQI for each dataset, and
uses that as the new time series column.
...
is a little smaller now.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_20_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
log transformations to ensure the data is stationary.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_25_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
ADF Test - Monthly AQI AVG without Log Transformation
ADF Statistic: -3.350751238120374
p-value: 0.012756803233213314
ADF Test - Monthly AQI AVG w/ Log Transformation
ADF Statistic: -3.4826220890374864
p-value: 0.008444774199784521
    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
ADF Test - Weekly AQI AVG without Log Transformation
ADF Statistic: -3.2934795957089746
p-value: 0.015172464527294545
ADF Test - Weekly AQI AVG w/ Log Transformation
ADF Statistic: -3.1750361754617558
p-value: 0.021475924955530693
    \end{Verbatim}
...
visuals which means air quality does suffer from seasonality.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_36_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
in this data.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
weekly aqi adf first difference p-value: 6.003770326620934e-20
monthly aqi adf first difference p-value: 7.186409585209823e-08

weekly aqi-log adf first difference p-value: 2.4132826548746984e-19
monthly aqi-log adf first difference p-value: 1.6924166308827316e-08
    \end{Verbatim}
...
Strong positive correlation (r close to +1): Suggests that AQI values
are similar across the lag --- good candidate for AR terms.

Strong negative correlation (r close to -1): Indicates inverse
relationship --- may suggest MA terms or seasonal effects.

Weak correlation (r near 0): Lag may not be useful for modeling.
...
----------
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_48_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
--------------
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_48_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
-----------
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_48_5.png}
    \end{center}
    { \hspace*{\fill} \\}
...
---------------
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Math6450_Assignment3_files/Math6450_Assignment3_48_7.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Calculates Pearson correlation between AQI and its lagged versions
using:

df{[}`AQI'{]}.corr(df{[}`AQI'{]}.shift(lag))

Plots scatter plots using Seaborn for each lag --- showing whether past
AQI values predict current AQI.

Prints a table of correlations for each dataset.

Works separately for weekly and monthly data, with their own appropriate
lag periods.

    📊 How to Interpret Results

Correlation (r) Meaning Interpretation

r \textgreater{} 0.7 Strong positive AQI is highly persistent → include
AR terms

0.3 \textless{} r ≤ 0.7 Moderate Some serial dependence → maybe AR(1) or
AR(2)

r \textless{} 0.3 Weak Little predictive power from that lag

Negative r Inverse relationship Could suggest mean reversion or
oscillation

    ✅ Example Output Summary (hypothetical) Weekly AQI ----------- Lag
Pearson\_r
...
AQI has strong persistence (AR(1--2)).

There's a seasonal correlation at lag 52 (annual). → Justify using
SARIMA(p,d,q)(P,D,Q,52) with p≈2, P≈1.
