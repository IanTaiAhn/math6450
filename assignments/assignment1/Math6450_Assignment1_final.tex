...
- Graphed Q-Q plot backs up the previously observed weak evidence of normality based on the test statistic
    ...
    \centering
    \adjustimage{max size={0.7\linewidth}{0.7\paperheight}}{Math6450_Assignment1_copy_for_pdf_render_files/Math6450_Assignment1_copy_for_pdf_render_31_1.png}
    \begin{Verbatim}[commandchars=\\\{\}]
...
Interpretation: Ratio > 2 or < 0.5 suggests heteroscedasticity
    \end{Verbatim}
    \centering
    \adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{Math6450_Assignment1_copy_for_pdf_render_files/Math6450_Assignment1_copy_for_pdf_render_38_1.png}
    \begin{Verbatim}[commandchars=\\\{\}]
...
Interpretation:
  * Moderate correlation suggests possible heteroscedasticity
    ...
    \centering
    \adjustimage{max size={0.4\linewidth}{0.4\paperheight}}{Math6450_Assignment1_copy_for_pdf_render_files/Math6450_Assignment1_copy_for_pdf_render_39_1.png}
